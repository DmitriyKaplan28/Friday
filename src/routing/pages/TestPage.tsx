...
function TestPage() {
  ...
  return (
    <div>
      ...
      {/*select, radio*/}
      <div>
        <SuperSelect options={arr} value={valueForSelectAndRadio} onChangeOption={onChangeOption} />
      </div>
      <div>
        <SuperRadio
          name={'radio'}
      ...
      <div>
        <span>{valueRange1}</span>
        <SuperDoubleRange value={[valueRange1, valueRange2]} onChangeRange={handleChange} />

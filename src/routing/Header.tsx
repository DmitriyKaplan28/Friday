...
function Header() {
    return (
        <div className={s.defaultHeader}>
            <NavLink to={'/profile'} className={s.links}>profile</NavLink>
            <NavLink to={'/login'} className={s.links}>login</NavLink>
            <NavLink to={'/sign-up'} className={s.links}>sign up</NavLink>
